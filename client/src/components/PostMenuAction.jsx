...
const PostMenuAction = ({post}) => {
  ...
  return (
    <div className=''>
        ...
        {isPending ? "Loading..." : error ? "Saved Post fetching failed..." : <div onClick={handleSave} className='flex items-center gap-2 p-2 text-sm cursor-pointer'> 
            <svg
        ...
        {user && (post.user.username === user.username || isAdmin) && <div onClick={handleDelete} className='flex items-center gap-2 p-2 text-sm cursor-pointer'> 
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 50 50"
                fill="red"
